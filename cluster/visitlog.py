...
OpenDatabase("/cluster/scratch/fkaufmann/le1_18.4k_phi_0.75/Uin_02.75/RUN01/inward.nek5000", 0)
...
View2DAtts.windowCoords = (-15, 15, -15, 15)
...
SaveWindowAtts.outputDirectory = "/cluster/home/fkaufmann/inward_prop/post_processed_data/le1_18.4k_phi_0.75/Uin_02.75_RUN01/images_CON"
...
SetActivePlots(0)
DeleteActivePlots()
OpenDatabase("/cluster/scratch/fkaufmann/le1_18.4k_phi_0.75/Uin_02.75/RUN01/inward.nek5000")
OpenDatabase("/cluster/scratch/fkaufmann/le1_18.4k_phi_0.75/Uin_02.75/RUN02/inward.nek5000", 0)
DefineScalarExpression("radius", "polar_radius(mesh)")
DefineScalarExpression("x-coord", "coord(mesh)[0]")
DefineScalarExpression("y-coord", "coord(mesh)[1]")
DefineScalarExpression("operators/ConnectedComponents/mesh", "cell_constant(<mesh>, 0.)")
...
# Begin spontaneous state
View2DAtts = View2DAttributes()
View2DAtts.windowCoords = (-16, 16, -16, 16)
View2DAtts.viewportCoords = (0.1, 1, 0.1, 1)
View2DAtts.fullFrameActivationMode = View2DAtts.Off  # On, Off, Auto
View2DAtts.fullFrameAutoThreshold = 100
View2DAtts.xScale = View2DAtts.LINEAR  # LINEAR, LOG
