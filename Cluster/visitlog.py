...
ShowAllWindows()
launchArguments = ("-l", "srun", "-la", "--mem-per-cpu=4096", "-np", "1", "-t", "14", "-hosts", "localhost")
OpenComputeEngine("localhost", launchArguments)
ResizeWindow(1, 1000, 1000)
OpenDatabase("/cluster/scratch/fkaufmann/base_18.4k_phi_0.6/Uin_02.40/RUN01/inward.nek5000", 0)
...
SaveWindowAtts.outputDirectory = "/cluster/home/fkaufmann/inward_prop/post_processed_data/base_18.4k_phi_0.6/Uin_02.40_RUN01/images_CON"
SaveWindowAtts.fileName = "T5_Isocon_t_final"
...
SetActivePlots(0)
DeleteActivePlots()
OpenDatabase("/cluster/scratch/fkaufmann/base_18.4k_phi_0.6/Uin_02.40/RUN01/inward.nek5000")
OpenDatabase("/cluster/scratch/fkaufmann/base_18.4k_phi_0.6/Uin_02.40/RUN02/inward.nek5000", 0)
DefineScalarExpression("radius", "polar_radius(mesh)")
DefineScalarExpression("x-coord", "coord(mesh)[0]")
DefineScalarExpression("y-coord", "coord(mesh)[1]")
DefineScalarExpression("operators/ConnectedComponents/mesh", "cell_constant(<mesh>, 0.)")
...
SaveWindowAtts = SaveWindowAttributes()
SaveWindowAtts.outputToCurrentDirectory = 0
SaveWindowAtts.outputDirectory = "/cluster/home/fkaufmann/inward_prop/post_processed_data/base_18.4k_phi_0.6/Uin_02.40_RUN02/images_CON"
SaveWindowAtts.fileName = "T5_Isocon_t_final"
SaveWindowAtts.family = 0
SaveWindowAtts.format = SaveWindowAtts.PNG  # BMP, CURVE, JPEG, OBJ, PNG, POSTSCRIPT, POVRAY, PPM, RGB, STL, TIFF, ULTRA, VTK, PLY, EXR
SaveWindowAtts.width = 1000
...
SetActivePlots(0)
DeleteActivePlots()
OpenDatabase("/cluster/scratch/fkaufmann/base_18.4